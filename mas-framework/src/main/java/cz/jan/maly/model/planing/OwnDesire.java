...
public abstract class OwnDesire<T extends Intention<? extends OwnDesire<T>>> extends InternalDesire<T> {
    OwnDesire(DesireKey desireKey, Memory memory, Commitment commitment, DecisionContainerParameters decisionDesire, RemoveCommitment removeCommitment, DecisionContainerParameters decisionIntention, IntentionParameters intentionParameters, boolean isAbstract) {
    ...
    public static class WithIntentionWithPlan extends OwnDesire<IntentionWithPlan<WithIntentionWithPlan>> {
        ...
        public WithIntentionWithPlan(DesireKey desireKey, Memory memory, Commitment commitment, DecisionContainerParameters decisionDesire, RemoveCommitment removeCommitment, DecisionContainerParameters decisionIntention, IntentionParameters intentionParameters, Command command) {
