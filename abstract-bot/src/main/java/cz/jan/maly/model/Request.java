...
public class Request {
    ...
    //todo use some internal id

    //it makes copy of sets
    public Request(Map<KeyToFact, Fact> facts, Set<Agent> agents, boolean canCommitOneAgentOnly, Agent requestFrom) {
    ...
    //it makes copy of sets
    public Request(Map<KeyToFact, Fact> facts, boolean canCommitOneAgentOnly, Agent requestFrom) {
        this.canCommitOneAgentOnly = canCommitOneAgentOnly;
        this.requestFrom = requestFrom;
        facts.forEach((keyToFact, fact) -> factsAboutThisProposal.put(keyToFact, keyToFact.createFact(fact)));
    }
    ...
    public Request copyRequest() {
        return new Request(factsAboutThisProposal, committedAgents, canCommitOneAgentOnly, requestFrom);
    }
